...
{% endfor %}
        			...
        			<span class="input-group-addon">
					    <input id="selectTypePlugin" type="radio" name="selectType" value="plugin" /> {{ lang.templates['tplmodules'] }}
					</span>
...
<!-- BLOCK TEMPLATES -->
        <table class="table">
            <tr>
			    <td colspan="2" style="background-color: #E0E0A0; padding: 3px;">{{ lang.templates['tpl.edit'] }} [ <b><span id="templateNameArea">default</span> </b>]</td>
			</tr>
            <tr>
