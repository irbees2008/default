...
<table class="table table-hover">
    ...
    <tr>
	    <td>{l_name}:</td>
		<td><span id="bk_editImageName">{name}</span> <a href="#" onclick="markNameEdit(); this.style.display='none';">{l_rename}</a></td>
	</tr>
    <tr>
	    <td>{l_url}:</td>
    ...
    <tr>
	    <td>{l_date}:</td><td>{date}</td>
	</tr>
    <tr>
	    <td>{l_author}:</td><td>{author}</td>
	</tr>
    <tr>
	    <td>{l_img_size}:</td><td>{width} x {height} ( {size} )</td>
	</tr>
    <tr>
	    <td>{l_category}:</td><td>{category}</td>
	</tr>
    <tr>
	    <td>{l_wmimage}:</td><td>[have_stamp]{l_added}[/have_stamp][no_stamp]<label><input type="checkbox" name="createStamp" value="1"/> {l_add}[/no_stamp]</td>
	</tr>
    <tr>
	    <td>{l_preview}:</td>
        <td>
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
					        <td colspan="2">
							    <label>
								    <input type="checkbox" name="flagPreview" value="1" /> {l_create_edit_preview}
								</label>
							</td>
						</tr>
                        <tr>
						    <td>{l_size_max}:</td>
							<td><input size="4" name="thumbSizeX" value="{thumb_size_x}"/> x <input size="4" name="thumbSizeY" value="{thumb_size_y}"/> {l_pixels}</td>
						</tr>
                        <tr>
