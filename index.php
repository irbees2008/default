		...
		<header class="topnav">
			...
			<div class="topnav-right">
				<ul class="topnav-menu">
				    <li>
						<a class="pm" href="#" class="dropdown-toggle" data-toggle="dropdown" title="Добавить">
					...
					<li>
						<a href="#" class="pm" data-toggle="dropdown" title="$unnAppText"><i class="fa fa-lg fa-bell-o " aria-hidden="true"></i>$unnAppLabel</a>
